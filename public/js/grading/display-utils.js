...
function createColorLegend() {
    return `
        <div class="color-legend" style="padding: 10px 15px; margin-top: 20px; border-top: 2px solid #ccc; background: #f9f9f9; font-size: 12px; user-select: none; pointer-events: none;">
